...
def show_management_window():
    ...
    manage_button = tk.Button(management_window, text="Purchase Stock", command=manage_stock)
    manage_button.pack()

    view_button = tk.Button(management_window, text="View orders", command=view_stock)
    view_button.pack()
...
login_window = tk.Tk()
login_window.title("Customer_Login")
